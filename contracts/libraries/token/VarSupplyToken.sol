...
import 'libraries/token/Token.sol';


contract VarSupplyToken is Token {
    ...
    */
    ...
    // Subclasses of this token may want to send more logs
    function onMint(address, uint256) internal returns (bool);

    // Subclasses of this token may want to send mroe logs 
